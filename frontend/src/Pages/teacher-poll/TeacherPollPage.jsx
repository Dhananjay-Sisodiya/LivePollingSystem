...
let apiUrl =
  import.meta.env.VITE_NODE_ENV === "production"
    ...
    : "https://livepollingsystem-xarz.onrender.com";
  ...
  useEffect(() => {
    ...
    socket.on('pollEnded', (data) => {
      ...
      if (data.finalResults) {
        ...
        setTotalVotes(Object.values(data.finalResults).reduce((a, b) => a + b, 0));
      }
    });
  ...
  return (
    <>
      ...
      <div className="container mt-5 w-50">
        ...
        <div className="mb-3">
          <p><strong>Teacher:</strong> {username}</p>
        </div>
        ...
        {!pollQuestion && (
          <div className="text-muted text-center">
            ...
            <p>Go back to create a new poll.</p>
            <button
              className="btn rounded-pill ask-question px-4 m-2"
              onClick={askNewQuestion}
            >
